  ...
  🛒 Cart ({cart.length})
      ...
      <section className="hero">
        <div className="hero-content">
          <h1>Because Your Skin Deserves the Best</h1>

          <p>
            Glow beyond expectations with skincare that hydrates,
            protects, and enhances your natural radiance every day.
          </p>
        </div>
      </section>
        ...
        <div className="category-list">
          ...
          <div
            className="category-card"
            onClick={() => setSelectedCategory("Cleanser")}
          >
            🧴 Cleanser
          </div>
          ...
          <div
            className="category-card"
            onClick={() => setSelectedCategory("Night Care")}
          >
            🌙 Night Care
          </div>
          ...
          <div
            className="category-card"
            onClick={() => setSelectedCategory("Moisturizer")}
          >
            💦 Moisturizer
          </div>
          ...
          <div
            className="category-card"
            onClick={() => setSelectedCategory("Lip Care")}
          >
            💄 Lip Care
          </div>
        </div>
...
<footer className="footer">
  <h3>HYPEN RADIANCE</h3>
  <p>Skincare That Loves Your Skin 💕</p>
</footer>
